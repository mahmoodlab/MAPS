...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_dir', type=str, default='datasets/DLBC_MIBI/', help='configuration_path')
    parser.add_argument('--result_dir', type=str, default='results/DLBC_MIBI/', help='configuration_path')
    ...
    for fid in range(5):
        ...
        marker_yaml_path = 'datasets/DLBC_MIBI/marker.yml'
        class_names = pd.read_csv('datasets/DLBC_MIBI/class_names.csv')['class_name'].tolist()
