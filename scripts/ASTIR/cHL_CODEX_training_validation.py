...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_dir', type=str, default='datasets/cHL_CODEX/', help='configuration_path')
    parser.add_argument('--result_dir', type=str, default='results/cHL_CODEX/', help='configuration_path')
    ...
    for fid in range(5):
        ...
        marker_yaml_path = 'datasets/cHL_CODEX/marker.yml'
        class_names = pd.read_csv('datasets/cHL_CODEX/class_names.csv')['class_name'].tolist()
