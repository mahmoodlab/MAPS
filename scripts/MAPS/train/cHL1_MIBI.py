...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_features', type=int, default='42', help='number of input features')
    ...
    parser.add_argument('--min_epochs', type=int, default='25', help='minimum number of epochs')
