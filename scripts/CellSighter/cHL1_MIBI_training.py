...
if __name__ == "__main__":
    ...
    fold_mapping= pd.read_csv('datasets/cHL1_MIBI/image_to_fold_mapping.csv')
    ...
    config["train_set"] = list(fold_mapping.loc[fold_mapping['fold_id'] != int(fid), 'folder_name'])
    config["train_set"].append('12')
    config["train_set"].append('6')
